...
public class StatsCompatController {
    ...
    private static final long WINDOW_SIZE_MS = 3L * 60L * 1000L; // ProductClickProcessor.WINDOW_SIZE 와 일치(3분)

    /**
     * 상품 클릭 통계(3분 윈도우) TOP N.
     *
    ...
    /**
     * Kafka Streams의 3분 텀블링 윈도우는 "epoch(1970) 기준"으로 3분 단위에 정렬됩니다.
